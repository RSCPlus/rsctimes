      ...
      if (commandType.contentEquals("settings")) { // list text commands e.g. ::bank
        switch (page) {
          ...
          case 2:
            ...
            Client.displayMessage(
                "@whi@::togglestatusdisplay - Toggle Hits display", Client.CHAT_QUEST);
            Client.displayMessage(
          ...
          case 3:
            ...
            Client.displayMessage("@whi@::togglefps - Toggle FPS hiding", Client.CHAT_QUEST);
            break;
          default:
        ...
        switch (page) {
          case 1:
            ...
            Client.displayMessage(
                "@whi@::[skillname] - Tells skill level in chat", Client.CHAT_QUEST);
            Client.displayMessage("@whi@::total - Shows total level in chat", Client.CHAT_QUEST);
            Client.displayMessage(
