...
public class ScaledWindow extends JFrame
  ...
  private void runInit() {
    ...
    setMinimumSize(new Dimension(512, 346 + Renderer.GAME_RENDER_OFFSET));
  ...
  public Dimension getMinimumViewportSizeForScalar() {
    return new Dimension(
        Math.round(512 * Renderer.renderingScalar),
        Math.round((346 + Renderer.GAME_RENDER_OFFSET) * Renderer.renderingScalar));
  }
  ...
  private void resizeApplet() {
    ...
    if (mudclient != null) {
      ...
      Renderer.resize(newWidth, newHeight - Renderer.GAME_RENDER_OFFSET);
    }
